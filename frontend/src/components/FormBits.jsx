...
export function TextInput({ label, ...props }) {
  return (
    <label className="grid gap-2">
      ...
      <input className="w-full rounded-xl border-2 border-slate-200 bg-white px-4 py-2.5 text-slate-900 outline-none ring-orange-400/30 transition-all duration-200 placeholder:text-slate-400 focus:border-orange-400 focus:ring-4" {...props} />
    </label>
  );
}
